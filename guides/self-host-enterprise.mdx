...
Powabase is available for self-hosting as part of the enterprise offering. The enterprise deployment is not a publicly self-serve product (for a single project, see the [open-source stack](https://github.com/powabase-ai/powabase)). The deployment is Kubernetes-based, the operations posture is "you run it, we support you," and you engage directly with the platform team rather than through docs-driven self-service.
