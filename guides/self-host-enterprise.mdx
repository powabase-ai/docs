...
Powabase is available for self-hosting as part of the enterprise offering. This isn't a publicly self-serve product — the deployment is Kubernetes-based, the operations posture is "you run it, we support you," and the engagement model is direct with the platform team rather than docs-driven self-service.

This page exists to position the option and pre-answer common questions; it does not ship the deploy runbook. If you're considering self-host, the next step is a conversation with sales — they'll route you to the platform team for the deploy walkthrough.
...
After the initial deploy, ongoing operational support is part of the enterprise contract — software updates, incident response, platform expertise for non-obvious situations.
