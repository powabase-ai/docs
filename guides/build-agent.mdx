...
description: "Create an AI agent, assign tools and knowledge bases, then chat with it via streaming. Agents use a ReAct loop — they reason, call tools, and respond."
icon: "robot"
---
