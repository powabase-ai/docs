...
The copilot itself runs as an agent under platform billing. Its model is configurable via `/api/copilot/settings/model` — defaults to `gpt-5.2`, with options including GPT-5.2, GPT-4.1, o3/o4, and Claude Opus/Sonnet/Haiku 4.x. Only function-calling-capable models are allowed.
