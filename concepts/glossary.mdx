...
**`ai`** schema. Where the AI surface's state lives. Platform-owned and backend-only: not exposed via PostgREST; reach it through the typed `/api/*` endpoints. See [The ai schema](/concepts/ai-schema-postgrest).
