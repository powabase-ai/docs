...
All five live in the Connect modal in the Studio.
...
**`config`** (on workflow blocks). The block's parameters — depends on block type (agent_id for agent blocks, code for code blocks, etc.).
