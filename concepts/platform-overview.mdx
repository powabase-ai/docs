...
| Full Document | One LLM-generated summary per document; returns the entire text on match | Whole-document retrieval over small/medium collections |
...
<Card title="Authentication" href="/guides/introduction">
