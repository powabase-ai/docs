...
description: "The platform's Context Engineering suite turns raw documents into intelligent, searchable knowledge. Choose from five indexing strategies and four retrieval algorithms to build the right pipeline for your use case — from simple vector search to LLM-driven document reasoning."
icon: "database"
---
