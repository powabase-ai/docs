...
Tell your coding assistant: "I'm building with the Powabase API. My base URL is \{BASE_URL\} and I'm using the service_role key for authentication. I need to [create a knowledge base / build an agent / set up a workflow]." This gives the assistant enough context to generate correct code.
</Tip>
