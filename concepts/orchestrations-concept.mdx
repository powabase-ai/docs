...
<Frame caption="Supervisor strategy: coordinator delegates to specialized agents">
  <img src="/diagrams/orchestration-flow.svg" alt="Orchestration flow: User → Coordinator → delegates to Agent A and Agent B → results merge → Coordinator synthesizes → Final Response." />
</Frame>
