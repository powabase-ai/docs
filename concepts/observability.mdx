...
The one public health endpoint. Returns 200 OK when the project's API service is reachable through Kong. It's lightweight enough to use as a synthetic uptime check.
...
The full list, because expectations matter:
