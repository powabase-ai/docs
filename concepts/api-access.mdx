...
description: "Powabase ships no typed SDKs today. Raw HTTP against the documented endpoints is the supported access path. What that means for your stack, and what's likely coming."
icon: "plug"
---
