...
<Frame caption="Agentic Platform covers the full AI application stack in one service">
  <img src="/diagrams/platform-comparison.svg" alt="Comparison chart showing feature coverage: Agentic Platform covers RAG, Agents, Workflows, Database, Auth, and Storage. Other platforms cover only subsets." />
</Frame>
...
| Capability | Agentic Platform | Supabase |
| --- | --- | --- |
...
| Capability | Agentic Platform | LangChain / LangGraph |
| --- | --- | --- |
...
| Capability | Agentic Platform | Agno |
| --- | --- | --- |
...
| Capability | Agentic Platform | Vectara |
| --- | --- | --- |
...
| Capability | Agentic Platform | Dify |
| --- | --- | --- |
...
| Capability | Agentic Platform | n8n |
| --- | --- | --- |
...
| Capability | Agentic Platform | CrewAI |
| --- | --- | --- |
